...
namespace Charge_States
{
    public partial class Form1 : Form
    {
        ...
        int z, z_t, z_t_gas, max, q, incharge; 
        ...
        private void button1_Click(object sender, System.EventArgs e)
        {
            ...
            z_t = 6; // Atomic number of target - here Carbon (z=6), foil.
            z_t_gas = 7; // Atomic number of gas target - here Nitrogen (z = 7), gas.
            ...
            velLabel.Text = u_mmpns.ToString("G8");
            ...
            for (int i = 0; i < z; i++)
            {
                ...
                List<Double> row = new List<Double>() { q, gauss_nd/sum_nd, I_I0_nd, gauss_s_foil/sum_s_foil, I_I0_s_foil, gauss_b/sum_b, I_I0_b, gauss_ss_foil/sum_ss_foil, I_I0_ss_foil, gauss_s_gas/sum_s_gas, I_I0_s_gas, gauss_ss_gas/sum_ss_gas, I_I0_ss_gas};
                //List<Double> row = new List<Double>() { (double)i + 1, gauss_nd, gauss_nd / max_nd, gauss_s_foil, gauss_s_foil / max_s_foil, gauss_b, gauss_b / max_b, gauss_s_gas, gauss_s_gas / max_s_gas };
                data.Add(row);
            }           
        ...
        public Tuple<double, double, double> f_schiwietz_schmitt() // Use for low Z values (He - C).
        {
            ...
            double c_2_foil = Math.Pow(z_t, c_1_foil);
        ...
        //
        private void button2_Click(object sender, EventArgs e) // Info box.
        {
